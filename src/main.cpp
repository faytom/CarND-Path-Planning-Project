          ...
          // j[1] is the data JSON object
            ...
            for (int i = 0; i < sensor_fusion.size(); i++)
            {
              ...
              if(d < (2 + 4 * lane + 2) && d > (2 + 4 * lane -2))
              {
                ...
                // project s value in 1 timestep
                check_car_s += ((double)prev_size * 0.02 * check_speed);
                // check the sensor fusion car is in front of our car and the distance is less than 30 meters
            ...
            {
              // take previous last two path points into consideration
            ...
            // in Frenet Coordinate add evenly 30m spaced ahead of the starting point
            ...
            // start all the previous path points
            ...
            {
              // calc for the number of segments
              ...
              // rotate back to normal x y coordinate
